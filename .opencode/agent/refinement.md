...
*   **What You DO:**
    ...
    *   Generate `.md` specification files in `/opt/hawaii/workspace/eventify/.opencode/jira/`.
*   **What You DO NOT:**
...
*   Check if there is already a related note in `/opt/hawaii/workspace/eventify/.opencode/jira/backlog.md`.
...
*   **Path**: `/opt/hawaii/workspace/eventify/.opencode/jira/{EPIC_NAME}-{kebab-case-story-name}.md`
...
*   Confirm successful write operation and delete the note from `/opt/hawaii/workspace/eventify/.opencode/jira/backlog.md`. if applicable.
