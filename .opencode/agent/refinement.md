...
*   Check if there is already a related note in `.opencode/jira/backlog.md`.
...
*   Confirm successful write operation and delete the note from `.opencode/jira/backlog.md`. if applicable.
