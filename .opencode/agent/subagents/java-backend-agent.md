...
**Note:** Tests already exist (created by java-testing-agent). Your job is to make them pass.
...
- See `springboot-standards/SKILL.md` for code patterns
- See `springboot-standards/references/patterns.md` for architecture examples
- See `springboot-standards/references/jframe.md` for search/pagination
