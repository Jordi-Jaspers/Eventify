...
- [ ] **UX-01: Admin sidebar grouping with labeled sections** - Beyond ADMIN-01's three-entry restructure, group admin entries under labeled sections (e.g., "Insights", "Resources", "Tools", "System") in the sidebar with collapsible headers. Apply same pattern to non-admin sidebar if it grows. Pure UX polish; not blocking.
