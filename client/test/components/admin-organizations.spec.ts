...
test.describe('Admin Organizations Page Screenshots', () => {
    ...
    test('create organization form - empty', async ({ page }, testInfo) => {
        ...
        const screenshotPath: string = getScreenshotPath('02-create-empty', testInfo.project.name);
    ...
    test('create organization form - filled', async ({ page }, testInfo) => {
        ...
        const screenshotPath: string = getScreenshotPath('03-create-filled', testInfo.project.name);
