...
<Dialog bind:open={isOpen}>
	...
	<DialogContent>
		<DialogHeader>
			...
			<DialogDescription>Enter the details to create a dashboard so you can start configuring it.</DialogDescription>
		</DialogHeader>
		<form id="create-dashboard" action="?/createDashboard" method="POST" use:enhance={createDashboard}>
			<div class="grid w-full items-center gap-4">
				...
				<div class="grid gap-2">
					...
					<p class="text-sm text-gray-500">Make this dashboard visible to everyone, including users outside your team.</p>
				</div>

				<DialogFooter class="mt-4">
					<Submit {isLoading} isDisabled={isLoading} title="Create Dashboard & Proceed" form="create-dashboard">
