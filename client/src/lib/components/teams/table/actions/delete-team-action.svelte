...
<Root bind:open={isDeleteDialogOpen} onOpenChange={() => (isDropdownOpen = false)}>
	<Content>
		<Header>
			...
			<Description>
				This action <b>cannot</b> be undone. This will permanently delete the team "{name}" and remove all its members.
			</Description>
		</Header>
		<Footer>
			<Cancel>Cancel</Cancel>
			<form method="POST" action="?/deleteTeam" use:enhance={deleteTeam}>
