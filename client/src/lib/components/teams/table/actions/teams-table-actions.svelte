...
<ManageMembersAction {id} {name} bind:isDropdownOpen bind:isManageMembersDialogOpen />

<UpdateTeamAction {id} {name} {description} bind:isDropdownOpen bind:isUpdateDialogOpen />

<DeleteTeamAction {id} {name} bind:isDropdownOpen bind:isDeleteDialogOpen />
