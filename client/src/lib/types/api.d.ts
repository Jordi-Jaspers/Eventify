...
export interface paths {
    ...
    "/v1/subscriptions/{id}": {
         ...
         */
        put: operations["updatePersonalSubscription"];
        post?: never;
        /**
         * Delete personal subscription
         * @description Deletes a personal subscription by ID
         */
        delete: operations["deletePersonalSubscription"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/organization/{orgId}/subscriptions/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        put: operations["updateOrgSubscription"];
        post?: never;
        /**
         * Delete org subscription
         * @description Deletes an org subscription by ID
         */
        delete: operations["deleteOrgSubscription"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/user/channel": {
         ...
         */
        delete: operations["batchDeleteChannels"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/user/channel/resume": {
         ...
         */
        post: operations["batchResumeChannels"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/user/channel/pause": {
         ...
         */
        post: operations["batchPauseChannels"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/subscriptions": {
         ...
         */
        post: operations["createPersonalSubscription"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/organization/{orgId}/subscriptions": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["createOrgSubscription"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/organization/{orgId}/subscriptions/search": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/organization/{orgId}/stats/timeline": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/organization/{orgId}/stats/summary": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/organization/{orgId}/channels": {
         ...
         */
        delete: operations["batchDeleteOrganizationChannels"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/organization/{orgId}/channels/resume": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["batchResumeOrganizationChannels"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/organization/{orgId}/channels/pause": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["batchPauseOrganizationChannels"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/organization/{orgId}/adapter-configs": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/admin/stats/growth": {
        ...
        get?: never;
        put?: never;
        /** Get growth data for admin dashboard */
    ...
    "/v1/admin/stats/event-volume": {
        ...
        get?: never;
        put?: never;
        /** Get event volume for admin dashboard */
        post: operations["getEventVolume"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/organization/{orgId}/status": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/organization/{orgId}/stats/api-keys": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get organization API key statistics (Owner/Admin only) */
    ...
    "/v1/admin/stats/counts": {
        ...
        /** Get platform counts for admin dashboard */
...
export interface components {
    schemas: {
        ...
        /** @description Request to update an adapter configuration */
        UpdateAdapterConfigRequest: {
            /**
        ...
        /** @description Adapter configuration resource */
        AdapterConfigResponse: {
             ...
             * @enum {string}
             */
            adapterType: "IN_APP" | "MATTERMOST" | "SLACK" | "EMAIL";
            /**
            ...
            /** @description Whether this configuration is enabled */
            enabled: boolean;
            /** @description Whether this adapter config is system-managed (auto-provisioned) */
        ...
        UpdateSubscriptionRequest: {
             ...
             *     ]
             */
            targetSeverities: ("CRITICAL" | "WARNING" | "OK" | "NO_DATA")[];
            /** @description Adapter config UUIDs to use for notification delivery */
        ...
        SubscriptionResponse: {
             ...
             */
            targetSeverities: ("CRITICAL" | "WARNING" | "OK" | "NO_DATA")[];
            /** @description Adapter config UUIDs for notification delivery */
            adapterConfigIds: string[];
            /**
             * Format: date-time
        ...
        /** @description Request to create an adapter configuration */
        CreateAdapterConfigRequest: {
            /**
             * @description Adapter type identifier
             * @example IN_APP
             * @enum {string}
        ...
        PageResourceSubscriptionResponse: {
            /**
             * Format: int64
             * @description Total number of elements available
             * @example 125
        ...
        /** @description Stats request — use either days or startDate+endDate, not both */
        StatsRequest: {
            /**
             * Format: int32
        ...
        /** @description A single bucket in the org error rate timeline */
        ...
        /** @description A single hourly bucket in the org event timeline */
        ...
        /** @description Organization event timeline */
        OrgTimelineResponse: {
            /** @description Hourly event timeline buckets */
            timeline: components["schemas"]["OrgTimelineBucketResponse"][];
            /** @description Error rate timeline buckets */
            errorTimeline: components["schemas"]["OrgErrorRateBucketResponse"][];
        };
        /** @description Organization event summary statistics */
        OrgSummaryResponse: {
            /**
             * Format: int64
        ...
        /** @description Admin growth data for the requested time window */
        AdminGrowthResponse: {
        ...
        /** @description Admin event volume data for the requested time window */
        AdminEventVolumeResponse: {
            ...
            dailyVolume?: components["schemas"]["DailyVolumePoint"][];
        };
        /** @description Daily event volume data point */
        DailyVolumePoint: {
            /**
             * Format: date
             * @description Date of the data point
        ...
        /** @description Request to test an adapter connection */
        TestAdapterConnectionRequest: {
            /**
        ...
        /** @description API key statistics for an organization */
        OrgApiKeyStatsResponse: {
            ...
            topKeys: components["schemas"]["OrgTopApiKeyResponse"][];
        };
        /** @description Top API key by request volume */
        OrgTopApiKeyResponse: {
            /**
             * @description API key name
        ...
        /** @description Admin platform counts for organizations, users and channels */
        AdminCountsResponse: {
            /**
             * Format: int64
...
export interface operations {
    ...
    update: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateAdapterConfigRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    batchDeleteChannels: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ChannelBatchRequest"];
            };
        };
        responses: {
            /** @description No Content */
    ...
    createPersonal: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateAdapterConfigRequest"];
            };
        };
        responses: {
            /** @description Created */
    ...
    searchPersonalSubscriptions: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PageResourceSubscriptionResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    batchDeleteOrganizationChannels: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    batchResumeOrganizationChannels: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    batchPauseOrganizationChannels: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    getEventVolume: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminEventVolumeResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    testConnection: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TestAdapterConnectionRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    updateOrganizationStatus: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateOrganizationStatusRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    getApiKeyStats: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OrgApiKeyStatsResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    getCounts: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminCountsResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
