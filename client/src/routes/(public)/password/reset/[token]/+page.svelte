	...
	<div class="flex h-full w-full items-center justify-center px-4">
		<Card class="snake">
			<CardHeader>
				...
				<CardDescription>Change your password to something new and make sure you remember it this time.</CardDescription>
			</CardHeader>
			<form id="reset" method="POST" use:enhance={resetPassword}>
				<CardContent class="grid gap-4">
					...
					<PasswordMeter password={formData.password} confirmation={formData.confirmation} bind:isValid={isPasswordValid} />
				</CardContent>
			</form>
			<CardFooter>
