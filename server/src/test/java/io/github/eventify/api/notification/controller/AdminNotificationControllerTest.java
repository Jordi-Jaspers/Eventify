...
public class AdminNotificationControllerTest extends IntegrationTest {
    ...
    public void sendBroadcastToAllUsersSuccess() throws Exception {
        ...
        final CreateBroadcastRequest request = aValidCreateBroadcastRequest("ALL_USERS", null, null);
        ...
        assertThat(broadcastResponse.getCategory(), is("ANNOUNCEMENT"));
        assertThat(broadcastResponse.getAudienceType(), is("ALL_USERS"));
    ...
    public void sendBroadcastToOrganizationSuccess() throws Exception {
        ...
        final CreateBroadcastRequest request = aValidCreateBroadcastRequest("ORGANIZATION", org.getId(), null);
        ...
        assertThat(broadcastResponse.getId(), is(notNullValue()));
        assertThat(broadcastResponse.getAudienceType(), is("ORGANIZATION"));
    ...
    public void sendBroadcastFailsWhenAudienceTypeMissing() throws Exception {
        ...
        final CreateBroadcastRequest request = aValidCreateBroadcastRequest(null, null, null);
    ...
    public void listBroadcastsSuccess() throws Exception {
        ...
        aBroadcastForAdmin(admin, "First Broadcast", "ALL_USERS");
        aBroadcastForAdmin(admin, "Second Broadcast", "ORGANIZATION");
    ...
    public void previewBroadcastFailsWhenAudienceTypeMissing() throws Exception {
        ...
        final AudienceRequest audienceRequest = anAudienceRequest(null, null, null);
    ...
    public void shouldFilterBroadcastsByCategory() throws Exception {
        ...
        aBroadcastForAdmin(admin, "Announcement Broadcast", "ALL_USERS");

        final CreateBroadcastRequest systemRequest = aValidCreateBroadcastRequest("ALL_USERS", null, null);
        systemRequest.setCategory("SYSTEM");
        mockMvc.perform(
        ...
        page.getContent().forEach(b -> assertThat(b.getCategory(), is("ANNOUNCEMENT")));
    }
    ...
    public void shouldFilterBroadcastsByTitle() throws Exception {
        ...
        aBroadcastForAdmin(admin, "Important System Update", "ALL_USERS");
        aBroadcastForAdmin(admin, "Weekly Newsletter", "ALL_USERS");
    ...
    public void shouldFilterBroadcastsBySentByEmail() throws Exception {
        ...
        aBroadcastForAdmin(admin, "Broadcast From First Admin", "ALL_USERS");
        aBroadcastForAdmin(secondAdmin, "Broadcast From Second Admin", "ALL_USERS");
    ...
    public void shouldFilterBroadcastsByCombinedFilters() throws Exception {
        ...
        aBroadcastForAdmin(admin, "Important Announcement", "ALL_USERS");
        aBroadcastForAdmin(admin, "Important Newsletter", "ALL_USERS");
        ...
        page.getContent().forEach(b -> {
            assertThat(b.getCategory(), is("ANNOUNCEMENT"));
