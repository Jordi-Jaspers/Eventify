package nl.vodafoneziggo.smc.cucc.common.exception.handler;

import io.swagger.v3.oas.annotations.media.Content;
import io.swagger.v3.oas.annotations.media.Schema;
import io.swagger.v3.oas.annotations.responses.ApiResponse;
import nl.vodafoneziggo.smc.cucc.common.exception.ApiErrorCode;
import nl.vodafoneziggo.smc.cucc.common.exception.GeneralDatabaseException;
...
public class ResponseEntityExceptionHandler {
     ...
     * Constructor.
     *
     * @param errorResponseEntityBuilder the error response entity builder
     */
