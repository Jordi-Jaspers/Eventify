...
public class DevelopmentEmailService implements EmailService {
    ...
    public void sendUserValidationEmail(final User recipient) {
        ...
        LOGGER.info("Sending user validation email with token '{}' to user '{}'.", token.getValue(), recipient.getEmail());
    ...
    public void sendPasswordResetEmail(final User recipient) {
        ...
        LOGGER.info("Sending password reset with token '{}' to user '{}'.", resetToken.getValue(), recipient.getEmail());
